...
/**
 * r187 — renderer genérico do {@link BloodWormModel} (verme segmentado 3D) para
 * qualquer {@link Mob}, usado pelo Verme Dimensional. Diferente do
 * {@code BloodWormRenderer} (fixo a Silverfish).
 */
public class WormRenderer<T extends Mob> extends MobRenderer<T, BloodWormModel<T>> {

    private final ResourceLocation texture;
    private final float baseScale;

    public WormRenderer(EntityRendererProvider.Context ctx, String texName, float baseScale) {
