...
/** r180c — Pá Energizada. */
public class EnergizedShovelItem extends ShovelItem {
    public static final int CAP = 200_000, COST = 120;
    public EnergizedShovelItem() { super(Tiers.NETHERITE, 1.5F, -3.0F, new Item.Properties().durability(1561).rarity(Rarity.RARE).fireResistant()); }
