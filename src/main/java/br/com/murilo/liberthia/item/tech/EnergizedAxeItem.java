...
/** r180c — Machado Energizado. */
public class EnergizedAxeItem extends AxeItem {
    public static final int CAP = 200_000, COST = 120;
    public EnergizedAxeItem() { super(Tiers.NETHERITE, 5.0F, -3.0F, new Item.Properties().durability(1561).rarity(Rarity.RARE).fireResistant()); }
