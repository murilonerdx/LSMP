...
/**
 * Clear Matter Bucket — places a clear matter block when used.
 */
public class ClearMatterBucketItem extends Item {

    public ClearMatterBucketItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide && level.getBlockState(placePos).isAir()) {
            level.setBlockAndUpdate(placePos, ModBlocks.CLEAR_MATTER_BLOCK.get().defaultBlockState());
